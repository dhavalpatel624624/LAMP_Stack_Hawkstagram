    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading text-center"><h2 id="photoUpload">Photo Upload</h2></div>
                <div class="panel-body">
                    <form class="" action="_uploadinstapic.php" method="post" enctype="multipart/form-data">
                        ...
                        .<div class="form-group">
                            <input type="submit" class="form-control btn btn-success" id="submit" name="upload" value="Upload your photo">
                        </div>
                    </form>
                </div>
            </div>
